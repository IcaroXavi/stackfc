    ...
    public class Dashboard extends JFrame {
        ...
        private JPanel painelPrincipal; // Container das telas
        private CardLayout navegador;   // Gerenciador de troca de telas
        private JLabel lblData;         // Referência global para atualizar a data

        public Dashboard(String nomeTime) {
            // Configurações da janela (simulador de celular)
        ...
        private JButton criarBotaoTab(String nome, String nomeArquivo) {
            ...
            btn.setCursor(new Cursor(Cursor.HAND_CURSOR)); // ADICIONE ESTA LINHA
